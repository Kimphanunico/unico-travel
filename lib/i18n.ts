...
export const ui = {
  en: {
    ...
    tour: {
      ...
      navHotels: "Hotels",
      navFaqs: "FAQs",
      navSimilar: "Similar Tours",
      journeyHeading: "The Journey",
      journeyBody: "This trip in stages, each with its own pace and highlights.",
      inclusionsOfThisTour: "Inclusions of This Tour",
      highlightsOfThisTour: "Highlights of This Tour",
      readMore: "Read more",
      readLess: "Read less",
      hotelList: "Hotel List",
      hotelListNote:
        "Hotels shown are illustrative selections in each category. Your trip designer will confirm final properties and availability once you enquire.",
      faqsHeading: "Frequently Asked Questions",
      similarToursHeading: "Similar Tours",
      bookThisTour: "Book This Tour",
      howItWorks: "How It Works",
      step1Title: "Send an inquiry",
      step1Body: "Tell us your dates and travel style, no commitment needed.",
      step2Title: "Get a free quote",
      step2Body: "Your trip designer tailors the itinerary and sends pricing.",
    ...
    buildModal: {
      heading: "Create Your Own Trip",
      intro: "Tell us your dream trip, and we'll take care of the rest.",
      destination: "Where do you want to go?",
      destinationPlaceholder: "Select a destination",
      interests: "Your interests",
      interestsPlaceholder: "e.g. beaches, food, trekking, culture",
      adults: "Adult(s)",
      children: "Child(ren)",
      tourClass: "Tour class",
      tourClassStandard: "Standard",
      tourClassDeluxe: "Deluxe",
      tourClassLuxury: "Luxury",
      when: "When?",
      whenPlaceholder: "e.g. March 2027",
      duration: "Trip duration (days)",
      notes: "Notes or special requests",
      fullName: "Full name",
      email: "Email address",
      phone: "Phone number",
      budget: "Your budget (USD/person, excl. flights)",
      budgetPlaceholder: "Select a range",
      budgetNote:
        "This is just a reference to match you with the right itinerary, not a fixed price.",
      submit: "Submit",
      submitting: "Sending...",
      successTitle: "Got it!",
      successBody: "Our trip designers will be in touch shortly with a tailored plan.",
    },
    enquireModal: {
      heading: "Contact Us",
      intro: "Have a question or a rough idea? Tell us and we'll get back to you.",
      message: "Your trip ideas, questions...",
      fullName: "Your name",
      email: "Email",
      phone: "Phone number",
      budget: "Your budget (USD/person, excl. flights)",
      ...
      successBody: "Thanks for reaching out, we'll reply as soon as we can.",
  ...
  vi: {
    ...
    tour: {
      ...
      navHotels: "Khách sạn",
      navFaqs: "Hỏi đáp",
      navSimilar: "Tour tương tự",
      journeyHeading: "Hành Trình Theo Chặng",
      journeyBody: "Chuyến đi này chia theo từng chặng, mỗi chặng có nhịp độ và điểm nhấn riêng.",
      inclusionsOfThisTour: "Dịch Vụ Bao Gồm Trong Tour",
      highlightsOfThisTour: "Điểm Nổi Bật Của Tour",
      readMore: "Xem thêm",
      readLess: "Thu gọn",
      hotelList: "Danh Sách Khách Sạn",
      hotelListNote:
        "Khách sạn hiển thị là lựa chọn minh họa cho từng hạng phòng. Chuyên viên tư vấn sẽ xác nhận khách sạn cụ thể và tình trạng phòng khi bạn gửi yêu cầu.",
      faqsHeading: "Câu Hỏi Thường Gặp",
      similarToursHeading: "Tour Tương Tự",
      bookThisTour: "Đặt Tour Này",
      howItWorks: "Quy Trình Đặt Tour",
      step1Title: "Gửi yêu cầu tư vấn",
      step1Body: "Cho chúng tôi biết ngày đi và phong cách du lịch bạn thích, chưa cần cam kết.",
      step2Title: "Nhận báo giá miễn phí",
    ...
    buildModal: {
      heading: "Thiết Kế Chuyến Đi Của Riêng Bạn",
      intro: "Kể cho chúng tôi nghe về chuyến đi trong mơ của bạn, phần còn lại cứ để Unico lo.",
      destination: "Bạn muốn đến đâu?",
      destinationPlaceholder: "Chọn điểm đến",
      interests: "Sở thích của bạn",
      interestsPlaceholder: "Ví dụ: biển, ẩm thực, trekking, văn hóa",
      adults: "Người lớn",
      children: "Trẻ em",
      tourClass: "Hạng tour",
      tourClassStandard: "Tiêu chuẩn",
      tourClassDeluxe: "Cao cấp",
      tourClassLuxury: "Hạng sang",
      when: "Thời gian dự kiến?",
      whenPlaceholder: "Ví dụ: Tháng 3/2027",
      duration: "Số ngày dự kiến",
      notes: "Ghi chú hoặc yêu cầu riêng",
      fullName: "Họ và tên",
      email: "Địa chỉ email",
      phone: "Số điện thoại",
      budget: "Ngân sách (USD/khách, chưa gồm vé máy bay)",
      budgetPlaceholder: "Chọn khoảng ngân sách",
      budgetNote:
        "Đây chỉ là mức tham khảo để chúng tôi tư vấn lịch trình phù hợp, không phải giá cố định.",
      submit: "Gửi Yêu Cầu",
      submitting: "Đang gửi...",
      successTitle: "Đã nhận được yêu cầu!",
      successBody: "Đội ngũ thiết kế hành trình của chúng tôi sẽ liên hệ với bạn sớm nhất.",
    },
    enquireModal: {
      heading: "Liên Hệ Với Chúng Tôi",
      intro: "Có câu hỏi hay đã có vài ý tưởng cho chuyến đi? Cứ chia sẻ, chúng tôi sẽ phản hồi sớm.",
      message: "Ý tưởng chuyến đi, câu hỏi của bạn...",
      fullName: "Họ và tên",
      email: "Email",
      phone: "Số điện thoại",
      budget: "Ngân sách (USD/khách, chưa gồm vé máy bay)",
      ...
      successBody: "Cảm ơn bạn đã liên hệ, chúng tôi sẽ phản hồi sớm nhất có thể.",
