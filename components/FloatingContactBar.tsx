      ...
      <div className="flex flex-col gap-1.5 py-2 pl-2">
        {items.map((item) => (
          <Link
            ...
            href={item.href}
            title={item.title}
            className="group flex items-center justify-end overflow-hidden rounded-l-lg bg-terracotta text-white shadow-md transition-colors hover:bg-terracotta-dark"
          >
